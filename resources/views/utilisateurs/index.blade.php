                                ...
                                @forelse ($utilisateurs as $utilisateur)
                                    <tr class="py-2 flex justify-between border-b-2 mt-2">
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="px-2 inline-flex leading-5 rounded-full bg-red-100 text-red-800">
                                                    inactif
                                                </span>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <form action="utilisateurs/{{ $utilisateur->id }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="text-gray-800 hover:text-red-500 transition duration-150 ease-in-out">
                    ...
                    <div>
                        <p class="text-right">
                            <a href="utilisateurs/create"
                                class="border-b-2 border-transparent text-indigo-500 hover:font-semibold hover:border-indigo-700 hover:text-indigo-700 transition duration-150 ease-in-out">
                                Créer un nouvel utilisateur &plus;
                            </a>
                        </p>
                    </div>
                </div>
